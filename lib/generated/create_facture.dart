...
class CreateFactureVariablesBuilder {
  ...
  CreateFactureVariablesBuilder(this._dataConnect, {required  this.totalPrice,});
  ...
  MutationRef<CreateFactureData, CreateFactureVariables> ref() {
    CreateFactureVariables vars= CreateFactureVariables(totalPrice: totalPrice,);
